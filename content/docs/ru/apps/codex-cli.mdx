...
description: Руководство по установке OpenAI Codex CLI — установка терминального AI-помощника по программированию в Windows, macOS, Linux с интеграцией с New API. Поддержка песочницы и атомарного патч-редактирования.
---
