...
description: Factory Droid CLI setup guide — install and configure this AI software engineering agent with __WEBSITE_NAME__. Supports end-to-end development from planning to testing.
---
