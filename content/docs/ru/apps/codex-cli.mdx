...
description: Руководство по установке OpenAI Codex CLI — установка терминального AI-помощника по программированию в Windows, macOS, Linux с интеграцией с __WEBSITE_NAME__. Поддержка песочницы и атомарного патч-редактирования.
---
