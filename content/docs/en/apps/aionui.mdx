...
description: AionUi Tutorial — A free open-source desktop office agent supporting various AI agents like Gemini CLI, Claude Code, Codex, and more. Integrates with __WEBSITE_NAME__ to enable multi-model workflows.
---
...
Please use your self-deployed __WEBSITE_NAME__, or ensure that the service provider offers __WEBSITE_NAME__ services with legitimate upstream authorization and compliance obligations. Do not connect API addresses or keys from unknown sources to a production environment.
...
4.  **Configure API Information**
    - API Address: Enter your NewAPI site address (format: `https://<your-newapi-domain>/v1`)
