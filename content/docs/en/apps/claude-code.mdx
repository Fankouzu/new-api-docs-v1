---
title: Claude Code
description: Claude Code configuration guide — use Anthropic's terminal-based coding agent with __WEBSITE_NAME__. Supports code understanding, multi-file editing, and IDE integration.
---
