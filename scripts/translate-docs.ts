...
7. 保持原文的语气和风格
8. 对于特殊的专有名词（如产品名 "__WEBSITE_NAME__"、"Cherry Studio" 等），保持不变
...
2. 专业术语使用行业标准翻译；专有名词（如 "__WEBSITE_NAME__"）保持不变。
...
9. 路径中的语言代码需要替换：将 /zh/ 替换为 /${dir}/（例如：href="/zh/docs/apps" → href="/${dir}/docs/apps"）
