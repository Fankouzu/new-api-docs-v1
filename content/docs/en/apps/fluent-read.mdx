...
description: FluentRead configuration guide — open-source browser translation plugin with 20+ engines and AI model support. Connect to Lychee AI for immersive bilingual reading.
---

<Callout type="info" title="Chat Settings Options">
  In the System Settings -> Chat Settings of the Lychee AI console, you can add
...
### Import Configuration from Lychee AI Console (Recommended)

After the FluentRead plugin is installed in your browser, opening the Lychee AI console -> Token Management page will display a prompt to add FluentRead.
...
After confirming the import, the Lychee AI configuration in FluentRead will be enabled.
