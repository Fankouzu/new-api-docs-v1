...
description: FluentRead configuration guide — open-source browser translation plugin with 20+ engines and AI model support. Connect to __WEBSITE_NAME__ for immersive bilingual reading.
---

<Callout type="info" title="Chat Settings Options">
  In the System Settings -> Chat Settings of the __WEBSITE_NAME__ console, you can add
...
### Import Configuration from __WEBSITE_NAME__ Console (Recommended)

After the FluentRead plugin is installed in your browser, opening the __WEBSITE_NAME__ console -> Token Management page will display a prompt to add FluentRead.
...
After confirming the import, the __WEBSITE_NAME__ configuration in FluentRead will be enabled.
