    ...
    questions: [
      {
        ...
        options: [
          { value: 'a', label: 'Коммерческая платформа продажи API' },
          {
            value: 'b',
            label:
              'Open-source система управления и распределения AI-интерфейсов',
          },
          { value: 'c', label: 'Платное программное обеспечение' },
          { value: 'd', label: 'Благотворительный API-сайт' },
        ],
        correct: 'b',
        errorMessage:
      ...
      },
      {
        id: 'q2',
        question:
          '2. Разрешено ли публиковать в группе информацию о покупке или продаже аккаунтов и API-продуктов?',
        options: [
          { value: 'true', label: 'Да' },
        ...
        correct: 'false',
        errorMessage:
          'Согласно правилу группы 2: в групповом чате запрещено публиковать любую информацию о покупке или продаже аккаунтов и API-продуктов.',
      },
      {
        id: 'q3',
      ...
      },
      {
        id: 'q4',
        question:
          '4. Обязаны ли владелец группы и администраторы предоставлять мне техническую поддержку?',
        options: [
          {
            value: 'true',
            label: 'Да, они обязаны предоставлять техническую поддержку',
          },
          {
            value: 'false',
            label:
              'Нет, они не обязаны предоставлять техническую поддержку; следует создать issue',
          },
        ],
        correct: 'false',
        errorMessage:
          'Согласно правилу группы 1: администраторы и владелец группы не обязаны предоставлять вам техническую поддержку. Если у вас есть вопросы, создайте issue.',
      },
      {
        id: 'q5',
        question:
          '5. Могу ли я покупать API-продукты, продаваемые администраторами в группе?',
        options: [
          { value: 'true', label: 'Да, могу купить' },
          {
            value: 'false',
            label: 'Нет, эта группа не продает API-продукты',
          },
        ],
        correct: 'false',
        errorMessage:
          'Согласно правилу группы 3: эта группа не продает API-продукты. Не доверяйте и не покупайте API-продукты ни у кого, включая администраторов.',
      },
    ],
    submitButton: 'Отправить ответы',
    answerAllQuestions: 'Пожалуйста, ответьте на все вопросы перед отправкой.',
    successTitle: 'Поздравляем, проверка пройдена!',
    successMessage:
      'Спасибо, что внимательно прочитали правила группы. Добро пожаловать в наше сообщество!',
    methodOne: 'Способ 1: отсканировать QR-код',
    methodTwo: 'Способ 2: перейти по ссылке',
    joinLink: 'Нажмите здесь, чтобы напрямую вступить в QQ-группу',
